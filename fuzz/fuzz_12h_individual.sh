#!/bin/bash
# Run a single issuer-service fuzz target for 12 hours
...
if [ $# -ne 1 ]; then
    ...
    echo "  - fuzz_redjubjub_signing"
    echo "  - fuzz_hmac_verification"
    echo "  - fuzz_base64_serde"
    echo "  - fuzz_json_parsing"
    exit 1
fi
